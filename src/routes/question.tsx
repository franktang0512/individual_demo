            ...
            example_cases: [
                {
                    ...
                    output: "3 7 9",
                    description: "新生們依序報名了編號為 1、4、2、6、10、11 、5、15、12、13、14、8 的活動 (-1表示結束)。編號 3、7、9 的活動未有新生報名。"
                },
                {
                    title: "範例二",
                    input: "7 3 9 12 1 15 6 10 4 14 9 2 9 13 8 5 11 -1",
                    output: "無",
                    description: "新生們依序報名了編號為 7、3、9、12、1、15、6、10、4、14、9、2、9、13、8、5、11 的活動 (-1表示結束)。所有活動皆有新生報名。"
                }
            ],
            cases: [
                {
